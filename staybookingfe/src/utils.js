...
//another way to write note/example of each paramater type
/**
 * 
 * @param {*} credential {username: string, password: string}
...
export const register = (credential, asHost) => {
  ...
  //only guest can access this API, so does not need any parameters
