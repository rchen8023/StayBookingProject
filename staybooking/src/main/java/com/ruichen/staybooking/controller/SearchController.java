...
import com.ruichen.staybooking.exception.InvalidSearchDateException;
import com.ruichen.staybooking.model.Stay;
import com.ruichen.staybooking.service.SearchService;
...
public class SearchController {
    ...
    public List<Stay> searchStays(
        ...
        List<Stay> result = searchService.search(guestNumber, checkinDate, checkoutDate, lat, lon, distance);
        return result;
    }
