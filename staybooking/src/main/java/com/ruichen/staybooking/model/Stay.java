package com.ruichen.staybooking.model;
...
public class Stay implements Serializable {
    @Id //make this field as primary key
    @GeneratedValue(strategy = GenerationType.AUTO) //adding id by 1 from existing id number
    private Long id;
    private String name;
    ...
    //without JsonIgnore, the reversedDates will be crashed when return back to frontend --> cause loop
    // Dates contains Stay object, and Stay object contains Dates --> so loop
    @JsonIgnore
